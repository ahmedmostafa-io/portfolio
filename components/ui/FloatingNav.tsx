      ...
      >
        {navItems.map((navItem: any, idx: number) => (
          <a
            ...
            href={navItem.link}
            className={cn(
              "relative dark:text-neutral-50 items-center justify-center flex  md:space-x-1 text-neutral-600 dark:hover:text-neutral-300 hover:text-neutral-500 group"
            )}
          >
        ...
        <a
          ...
          className="border text-sm font-medium relative border-neutral-200 dark:border-white/[0.2] text-black dark:text-white sm:px-2 sm:py-1 px-4 py-2 rounded-full group hover:bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 hover:text-white transition-all duration-200"
        >
          <span>
